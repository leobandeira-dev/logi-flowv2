          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-4 gap-6 max-w-4xl mx-auto mt-16">
              <div className="bg-white p-6 rounded-xl shadow-lg border-t-4 border-cyan-500">
                <p className="font-bold text-3xl text-cyan-700 mb-2">20+</p>
                <p className="text-sm text-gray-600">Módulos Integrados</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg border-t-4 border-blue-500">
                <p className="font-bold text-3xl text-blue-700 mb-2">4</p>
