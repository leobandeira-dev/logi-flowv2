    ...
    <>
      ...
      <div className="fixed inset-0 bg-gray-100 z-50 no-print">
        <div className="h-full flex flex-col">
          {/* Header */}
          <div className="flex items-center justify-between px-6 py-5 bg-gradient-to-r from-slate-800 to-slate-900 border-b border-slate-700 shadow-xl">
            <h1 className="text-2xl font-bold text-white">Apresentação Institucional - LogiFlow</h1>
