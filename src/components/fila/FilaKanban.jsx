                          ...
                          {(provided, snapshot) => (
                            ...
                            >
                              <CardContent className="p-4 space-y-3">
                                ...
                                {/* Motorista */}
                                <div>
                                  <p className="text-xs font-semibold mb-1" style={{ color: theme.textMuted }}>Motorista</p>
                                  <p className="font-bold" style={{ color: theme.text }}>{item.motorista_nome}</p>
                                </div>

                                {/* CPF e Telefone */}
                                <div className="grid grid-cols-2 gap-2">
                                  <div>
                                    <p className="text-xs" style={{ color: theme.textMuted }}>CPF</p>
                                    <p className="text-xs font-mono" style={{ color: theme.text }}>{item.motorista_cpf}</p>
                                  </div>
                                  <div>
                                    <p className="text-xs" style={{ color: theme.textMuted }}>Telefone</p>
                                    <div className="flex items-center gap-1">
                                      <p className="text-xs" style={{ color: theme.text }}>{formatarTelefone(item.motorista_telefone)}</p>
                                ...
                                {/* Placas */}
                                <div>
                                  <p className="text-xs" style={{ color: theme.textMuted }}>Cavalo</p>
                                    ...
                                    <div className="mt-1 space-y-0.5">
                                      {item.implemento1_placa && (
                                        <p className="text-xs font-mono" style={{ color: theme.textMuted }}>
                                          Impl. 1: {item.implemento1_placa}
                                        </p>
                                      )}
                                      {item.implemento2_placa && (
                                        <p className="text-xs font-mono" style={{ color: theme.textMuted }}>
                                          Impl. 2: {item.implemento2_placa}
                                        </p>
                                      )}
                                    </div>
                                  )}
                                ...
                                {item.tipo_veiculo && (
                                  <div>
                                    <p className="text-xs" style={{ color: theme.textMuted }}>Tipo</p>
                                ...
                                {item.localizacao_atual && (
                                  <div>
                                    <p className="text-xs" style={{ color: theme.textMuted }}>Localização</p>
                                ...
                                <div className="flex items-center justify-between pt-2 border-t" style={{ borderColor: theme.cardBorder }}>
                                  <div>
                                    <p className="text-xs" style={{ color: theme.textMuted }}>Entrada</p>
