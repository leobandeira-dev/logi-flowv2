                          ...
                          {(provided, snapshot) => (
                            <Card
                              ...
                              <CardContent className="p-2.5 space-y-1.5">
                                ...
                                {/* Placas e Tipo em linha única */}
                                <div className="text-[11px] space-y-0.5">
                                  <div className="flex items-center gap-2">
                                    <span className="text-[10px]" style={{ color: theme.textMuted }}>Cavalo:</span>
                                    <span className="font-mono font-bold" style={{ color: theme.text }}>{item.cavalo_placa}</span>
                                  </div>
                                  {(item.implemento1_placa || item.implemento2_placa) && (
                                    <div className="flex items-center gap-1">
                                      <span className="text-[10px]" style={{ color: theme.textMuted }}>Impl:</span>
                                ...
                                {item.localizacao_atual && (
                                  <div className="text-[11px]">
                                    <span className="text-[10px]" style={{ color: theme.textMuted }}>Local: </span>
                                    <span style={{ color: theme.text }}>{item.localizacao_atual}</span>
                                  </div>
                                )}

                                {/* Tempo na fila */}
                                <div className="flex items-center justify-between pt-1.5 border-t" style={{ borderColor: theme.cardBorder }}>
