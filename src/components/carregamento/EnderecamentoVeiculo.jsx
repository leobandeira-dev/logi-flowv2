  ...
  const handleDragEnd = async (result) => {
    ...
    if (destination.droppableId.startsWith("cell-")) {
      ...
      if (draggableId.startsWith("nota-")) {
        ...
        // Se está realocando da célula (draggableId tem sufixo -celula-)
