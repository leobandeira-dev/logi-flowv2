      ...
      <CardContent className="p-8 space-y-6">
        ...
        <section>
          ...
          <div className="mb-6">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border-2 border-blue-400 rounded-lg p-4">
              <p className="text-sm" style={{ color: theme.textMuted }}>
                📄 <strong>Documento separado:</strong> GU-LOG-001 - Guia do Motorista para Check-in na Fila X
              </p>
              <p className="text-xs mt-2" style={{ color: theme.textMuted }}>
                Este guia está disponível como documento independente no menu Procedimentos, 
                podendo ser impresso e distribuído aos motoristas.
              </p>
            </div>
          </div>
        </section>
