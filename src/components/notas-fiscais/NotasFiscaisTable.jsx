          ...
          <CardContent>
            ...
            <p className="text-xs mt-1" style={{ color: theme.textMuted }}>
              {(() => {
                ...
                return notasHoje.reduce((sum, n) => sum + (n.quantidade_total_volumes_nf || 0), 0);
              })()} volumes hoje
            </p>
          </CardContent>
          </Card>
          ...
          <CardContent>
            ...
            <p className="text-xs mt-1" style={{ color: theme.textMuted }}>
              R$ {(() => {
                ...
                return notasHoje.reduce((sum, n) => sum + (n.valor_nota_fiscal || 0), 0).toLocaleString('pt-BR', { minimumFractionDigits: 2 });
              })()} recebidos hoje
            </p>
          </CardContent>
        </Card>
