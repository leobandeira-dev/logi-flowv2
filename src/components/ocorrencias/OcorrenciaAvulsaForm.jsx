...
import { FileText, Save, User, Building2 } from "lucide-react";
...
export default function OcorrenciaAvulsaForm({ 
  open, 
  onClose, 
  onSubmit,
  tiposOcorrencia = [],
      ...
      <DialogContent className="sm:max-w-2xl">
        <DialogHeader>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
            Ocorrências avulsas são registros independentes, sem vínculo com ordens ou etapas específicas.
            Use para problemas gerais, observações ou tarefas administrativas.
          </p>
        </DialogHeader>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-green-700 dark:text-green-400">
                  Esta ocorrência será registrada como <strong>AVULSA</strong>, sem vínculo com nenhuma ordem de carregamento ou etapa específica.
                  Um número de ticket será gerado automaticamente.
                </p>
              </div>
            </div>
          </div>
